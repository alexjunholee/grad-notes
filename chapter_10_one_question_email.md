...
서로 독립된 주제는 별도 메일로 나눌 수 있지만, 짧은 시간에 여러 메일을 보내면 수신자에게 과도한 부담을 주기 쉽다. 상대의 선호에 따라 한 메일 안에서 소제목과 번호로 구분하는 방법도 있다. 중요한 것은 각 요청의 담당자·기한·원하는 답변이 섞이지 않게 하는 일이다.
